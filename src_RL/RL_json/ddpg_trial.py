...
def get_critic():
    ...
    state_output = layers.Dense(32, activation="tanh")(state_out)
...
#Save model to file
target_actor.save("pendulum_target_actor",'./')
target_critic.save("pendulum_target_critic",'./')

from keras.models import model_from_json
# serialize model to JSON
pendulum_target_actor_json = target_actor.to_json()
with open("pendulum_target_actor.json", "w") as json_file:
    json_file.write(pendulum_target_actor_json)
...
from keras.models import model_from_json
# serialize model to JSON
pendulum_target_critic_json = target_critic.to_json()
with open("pendulum_target_critic.json", "w") as json_file:
    json_file.write(pendulum_target_critic_json)
# serialize weights to HDF5
